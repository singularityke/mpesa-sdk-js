...
- Verify if a B2C payment was successful when callback wasn't received
- Check the status of a B2B transfer
...
Ensure you're using the correct transaction ID format.
...
Verify your callback route exists and is accessible.
